...
export const KialiIcon: { [name: string]: React.FunctionComponent<IconProps> } = {
  ...
  RequestRouting: (props: IconProps) => <CubesIcon className={props.className} />,
  ...
  TCPTrafficShifting: (props: IconProps) => <BalanceScaleIcon className={props.className} />,
  TrafficShifting: (props: IconProps) => <BalanceScaleIcon className={props.className} />,
